    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                ...
                <a href="{{route('contact')}}" class="btn btn-outline-dark py-2 px-4 animated slideInRight">Contact Us</a>
            </div>
            <div class="col-lg-6">
                <img class="img-fluid animated pulse infinite" src="{{asset('assets/frontend-assets/img/shampoo-1.png')}}" alt="">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <img class="img-fluid animated pulse infinite" src="{{asset('assets/frontend-assets/img/shampoo-1.png')}}">
            </div>
...
<div class="container-fluid deal bg-primary my-5 py-5">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <img class="img-fluid animated pulse infinite" src="{{asset('assets/frontend-assets/img/shampoo-2.png')}}">
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                <div class="product-item text-center border h-100 p-4">
                    <a href="{{route('details', $single_product->id)}}"><img class="img-fluid mb-4" src="{{asset('/')}}assets/frontend-assets/img/{{$single_product->image}}" alt=""></a>
                    <div class="mb-2">
                    ...
                    <h5 class="text-primary mb-3">{{$single_product->price}}</h5>
